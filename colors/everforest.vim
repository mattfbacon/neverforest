...
" }}}
" Syntax: {{{
call everforest#highlight('Boolean', s:palette.none, s:palette.none)
call everforest#highlight('Number', s:palette.none, s:palette.none)
call everforest#highlight('Float', s:palette.none, s:palette.none)
if s:configuration.enable_italic
  call everforest#highlight('PreProc', s:palette.none, s:palette.none, 'italic')
  call everforest#highlight('PreCondit', s:palette.none, s:palette.none, 'italic')
  call everforest#highlight('Include', s:palette.none, s:palette.none, 'italic')
  call everforest#highlight('Define', s:palette.none, s:palette.none, 'italic')
  call everforest#highlight('Conditional', s:palette.none, s:palette.none, 'italic')
  call everforest#highlight('Repeat', s:palette.none, s:palette.none, 'italic')
  call everforest#highlight('Keyword', s:palette.none, s:palette.none, 'italic')
  call everforest#highlight('Typedef', s:palette.none, s:palette.none, 'italic')
  call everforest#highlight('Exception', s:palette.none, s:palette.none, 'italic')
  call everforest#highlight('Statement', s:palette.none, s:palette.none, 'italic')
else
  call everforest#highlight('PreProc', s:palette.none, s:palette.none)
  call everforest#highlight('PreCondit', s:palette.none, s:palette.none)
  call everforest#highlight('Include', s:palette.none, s:palette.none)
  call everforest#highlight('Define', s:palette.none, s:palette.none)
  call everforest#highlight('Conditional', s:palette.none, s:palette.none)
  call everforest#highlight('Repeat', s:palette.none, s:palette.none)
  call everforest#highlight('Keyword', s:palette.none, s:palette.none)
  call everforest#highlight('Typedef', s:palette.none, s:palette.none)
  call everforest#highlight('Exception', s:palette.none, s:palette.none)
  call everforest#highlight('Statement', s:palette.none, s:palette.none)
endif
call everforest#highlight('Error', s:palette.none, s:palette.none)
call everforest#highlight('StorageClass', s:palette.none, s:palette.none)
call everforest#highlight('Tag', s:palette.none, s:palette.none)
call everforest#highlight('Label', s:palette.none, s:palette.none)
call everforest#highlight('Structure', s:palette.none, s:palette.none)
call everforest#highlight('Operator', s:palette.none, s:palette.none)
call everforest#highlight('Title', s:palette.none, s:palette.none, 'bold')
call everforest#highlight('Special', s:palette.none, s:palette.none)
call everforest#highlight('SpecialChar', s:palette.none, s:palette.none)
call everforest#highlight('Type', s:palette.none, s:palette.none)
call everforest#highlight('Function', s:palette.none, s:palette.none)
call everforest#highlight('String', s:palette.none, s:palette.none)
call everforest#highlight('Character', s:palette.none, s:palette.none)
call everforest#highlight('Constant', s:palette.none, s:palette.none)
call everforest#highlight('Macro', s:palette.none, s:palette.none)
call everforest#highlight('Identifier', s:palette.none, s:palette.none)
call everforest#highlight('Todo', s:palette.orange, s:palette.none, 'bold,italic')
if s:configuration.disable_italic_comment
  call everforest#highlight('Comment', s:palette.orange, s:palette.none)
  call everforest#highlight('SpecialComment', s:palette.orange, s:palette.none)
else
  call everforest#highlight('Comment', s:palette.orange, s:palette.none, 'italic')
  call everforest#highlight('SpecialComment', s:palette.orange, s:palette.none, 'italic')
endif
...
highlight! link DiagnosticUnnecessary Grey
highlight! link @lsp.type.comment.c Grey
